...
// space as the vnet
func CreateNonParagliderVirtualNetwork(ctx context.Context, h *AzureSDKHandler, location string, vnetName string, addressSpace string) (*armnetwork.VirtualNetwork, error) {
...
// func getNonParagliderVM() *armcompute.VirtualMachine {
// 	return &armcompute.VirtualMachine{
// 		Name:     to.Ptr(invalidVmName),
// 		Location: to.Ptr(testLocation),
// 		ID:       to.Ptr(invalidVmURI),
// 	}
// }

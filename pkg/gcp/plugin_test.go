...
const (
	...
	fakeResourceId = fakeProject + "/" + fakeZone + "/" + fakeInstance
	fakeOperation  = "operation-fake"
)

// Fake tag for fake resource (generated by getTag)
var fakeTag = getGCPTag(fakeResourceId)
...
var (
	...
	urlZoneInstance  = fmt.Sprintf("/zones/%v/instances/%v", fakeZone, fakeInstance)
)
...
func TestGetPermitListMissingInstance(t *testing.T) {
	...
	s := &GCPPluginServer{}
	resource := &invisinetspb.Resource{Id: fakeProject + "/" + fakeZone + "/" + "vm-missing"}

...
type AzureSDKHandler interface {
	...
	GetInvisinetsVnet(ctx context.Context, vnetName string, location string, frontendAddr string) (*armnetwork.VirtualNetwork, error)
...
func (h *azureSDKHandler) GetInvisinetsVnet(ctx context.Context, vnetName string, location string, frontendAddr string) (*armnetwork.VirtualNetwork, error) {

...
r = requests.post("http://0.0.0.0:8080/tags/{}".format("exampletag"), data=tag_mapping)
print(r.text)
...
r = requests.post("http://0.0.0.0:8080/tags/{}/delmembers".format("exampletag"), data=tag_mapping)
print(r.text)
